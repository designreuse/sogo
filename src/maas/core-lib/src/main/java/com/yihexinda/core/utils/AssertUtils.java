...
public class AssertUtils {
	 ...
	 * <code>BussException</code> if the test result is
	 * <code>false</code>.
	 * 
	 * <pre class="code">
	...
	public static void notAllNull(Object object,Object objectSec) {
		if (object == null &&  objectSec == null) {
				throw new BussException("[Assertion failed] - this argument is required; it must not all be null");
		}
	}
	...
	public static void notAllNullAndEmpty(String object,String objectSec,String message) {
		if (StringUtil.isEmpty(object) && StringUtil.isEmpty(objectSec)) {
				throw new BussException(message);
		}
	}
	...
	public static void notAllNullAndEmpty(String object,String objectSec) {
		if (StringUtil.isEmpty(object) &&  StringUtil.isEmpty(objectSec)) {
				throw new BussException("[Assertion failed] - this argument is required; it must not all be null or empty");
	...
	public static void notSingleNull(Object object,Object objectSec) {
		if (object != null ||  objectSec != null) {
			if (object == null ||  objectSec == null) 
				throw new BussException("[Assertion failed] - this argument is required; it must not be null");
		}
	}
	...
	public static void notSingleNullAndEmpty(String object,String objectSec) {
		if (!StringUtil.isEmpty(object) ||  !StringUtil.isEmpty(objectSec)) {
			if (StringUtil.isEmpty(object) || StringUtil.isEmpty(objectSec))
				throw new BussException("[Assertion failed] - this argument is required; it must not be null or empty");
	...
	public static void isInstanceOf(Class type, Object obj, String message) {
		...
		if (!type.isInstance(obj)) {
			throw new BussException(message + "Object of class ["
	...
	public static void isAssignable(Class superType, Class subType,
		...
		if (subType == null || !superType.isAssignableFrom(subType)) {
			throw new BussException(message + subType
	 ...
	 * throw BussException on an assertion failure.
	 * 
	 * <pre class="code">
	 ...
	 *
	 * @param expression a boolean expression
	 * {@link BussException} on an assertion failure.
	 * 
	 * <pre class="code">
