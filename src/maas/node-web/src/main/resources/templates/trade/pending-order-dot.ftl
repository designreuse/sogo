...
<div class="layui-tab">
    ...
    <#--待抢单-->
        ...
        <#--</div>-->
        <p style="color: #26bec5;">订单处理 > 抢单</p>
                ...
                <div class="layui-form-item">
                    <div class="layui-inline">
                        <button class="layui-btn layui-btn-primary layui-btn-radius" lay-submit lay-filter="formDemo"
                                style="height: 27px;line-height: 27px;">查询
                        </button>
                    </div>
                    <div class="layui-inline" style="margin-right: 246px;">
                        <button class="layui-btn layui-btn-radius" type="reset" style="height: 27px;line-height: 27px;">
                            重置
                        </button>
                    </div>
    ...
    layui.use(['form', 'element', 'laydate', /*'vip_table',*/'table', 'laytpl'], function () {
        ...
        var options = {
            ...
            , cols: [[                  //标题栏
                ...
                , {field: 'orderProperty', title: '订单来源', width: 86,templet:'#orderTpl'}
                , {field: 'robOutTime', title: '抢单倒计时', width: 100, templet: '#timeTpl'}
                , {field: 'orderSource', title: '订单渠道', width: 120}
                , {field: '', title: '乘机人', width: 100}
        ...
        var endorsement_options = {
            ...
            , cols: [[                  //标题栏
                ...
                , {field: 'remarkInfo', title: '签注内容', width: 140}
        ...
        //已抢订单loading
        var grabSingle_index;
        var grabSingle_time;
        var msTime,layermsg_index;
        ...
        table.on('tool(demo)', function (obj) {
            ...
            if (obj.event === 'detail') {
                ...
                window.parent.callParentHandler(1);
                $.ajax({
                    url: _PATH + "/api/order/grabOrder/" + data.id,
                    ...
                    success: function (_data) {
                        if (_data.success) {
                           ...
                           grabSingle_index = layer.load(0, {shade: [0.5, '#393D49'], title: "抢单确认中...."});
                          //   layer.load(0, {shade: [0.5, '#393D49'], title: "抢单确认中...."});
                           //

                            //抢单以后开始轮询
                            layer.msg(_data.msg, {icon: 1});
                            // layer.close(layermsg_index);
                            // confirmGrabbedOrder(data.orderNo);
                           beginMessage(data.id);
                           setTimeout(function(){
                               table.reload("dataCheck",options);
                           },2000) ;
                        } else {
       ...
       // beginMessage();
        ...
        //-------------------------已抢订单确认接口-----------------------------------
        function confirmGrabbedOrder(orderId,_data) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.success) {
                        ...
                        window.parent.callParentHandler(0);
...
///-------------------------------------状态切换按钮----------------------------------------------
        ...
        showTabNav();
        function showTabNav(){
           console.log("--切换--",window.parent.getThisNavTab("/trade/pending-order-dot.html")) ;
        }
...
<script type="text/html" id="timeTpl">
    ...
    return  '<span class="robOutTime" data-time="'+d.robOutTime+'">'+msg+'</span>';
    };
    }}
    {{ fn() }}
</script>
...
<script type="text/html" id="barOption">
    ...
    <a class="layui-btn layui-btn-xs" lay-event="endorsement">抢单</a>
