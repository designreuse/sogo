...
<script type="text/javascript">
    layui.use(['form','element','laydate',/*'vip_table',*/'table' ,'laytpl'], function () {
        ...
        $("#addBtn").click(function(){
            ...
            var data = {ruleName:"", ruleValue:"" ,ruleProperty:"" ,sort:"",timeOutMinutes:"",orderType:"",sendBackNum:""};
            var getTpl = editDemo.innerHTML;
            laytpl(getTpl).render(data, function(html) {
                //自定页
...
<script id="editTpl" type="text/html">
    <form class="layui-form layui-form-pane" id="editForm" action="">
        ...
        <div class="layui-form-item" style="margin-bottom: 5px;">
            ...
            <div class="layui-input-block">
                <select name="orderType" lay-filter="ruleType" style="height: 38px;">
                    <option value=""></option>
                    <option value="0"></option>
                    <option value="1" selected="">出票</option>
                </select>
            </div>
        </div>
        <div class="layui-form-item" style="margin-bottom: 5px;">
