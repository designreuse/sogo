        ...
        var options = {
          ...
          //  , height: 500    //容器高度
            , cols: [[                  //标题栏
                ...
                , {field: 'orderEntranceTime ', title: '进单时间', width: 180}
...
<script  type="text/html" id="orderTpl">
    {{# if(d.orderProperty =='新'){ }}
        <span class="layui-badge">{{d.orderProperty}}
    {{#  } else { }}</span>
                            ...
                            <div class="layui-form-item" style="margin-bottom: 5px;">
                                ...
                                <div class="layui-input-block">
                                            ...
                                            <select name="modules" lay-verify="required" lay-search="">
                                                ...
                                                <option value="1">G100400</option>
                                                <option value="2">G100401</option>
                                                <option value="3">G100402</option>
                                                <option value="4">G100403</option>
                                                <option value="5">G100404</option>
                                                <option value="6">G100405</option>
                                                <option value="7">G100406</option>
                                                <option value="8">G100407</option>
