    ...
    <#--<div class="layui-tab-content" style="height: 100px; border: #ece8e8 0.5px solid;">-->
        ...
        <hr style = "height: 2px;background-color: #9a9393;" class="layui-bg-blue">
            <form class="layui-form" action="">
                ...
                <div class="layui-form-item">
                    <div class="layui-inline" id="statusBtn" >
        ...
        var options = {
          ...
          //  , height: 500    //容器高度
            , cols: [[                  //标题栏
                ...
                , {field: 'manageStatus', title: '处理状态', width: 100}
                ...
                , {field: 'orderEntranceTime', title: '进单时间', width: 130,templet: '#orderEntranceTimeTpl'}
                , {field: 'dispatchTime', title: '派单时间', width: 130,templet: '#disPatchTimeTpl'}
                , {field: 'dealOutTime', title: '处理倒计时', width: 100,templet: '#dealOutTimeTpl'}
            ...
            // , method: 'get'//'post'
            ,url:_PATH+"/api/order/queryOrderPage"
            , method: 'post'//'post'
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.success) {
                        ...
                        layer.msg('已经派到订单，到调度平台处理', {icon: 1});
...
///-------------------------------------状态切换按钮----------------------------------------------
        ...
        $("#switchBtn button").eq(2).css("color","red");
        ...
        showTabNav();
        function showTabNav(){
            console.log("--切换--",window.parent.getThisNavTab("/trade/already-dispatched-master.html")) ;
        }
...
<script type="text/html" id="barOption">
    ...
    <a class="layui-btn layui-btn-primary layui-btn-xs" lay-event="tempLock">暂</a>
    {{#  } }}
    {{# if(d.manageStatus  == "已暂存"){ }}
    <a class="layui-btn layui-btn-primary layui-btn-xs" lay-event="tempLock">暂</a>
    {{#  } }}
    {{# if(d.manageStatus  != "已退回"&&d.manageStatus  != "已完成"){ }}
    <a class="layui-btn layui-btn-primary layui-btn-xs" lay-event="dispatch">退</a>
    {{#  } }}
