...
<#--&lt;#&ndash;<button class="layui-btn layui-btn-primary layui-btn-sm" type="button" >待派单</button>&ndash;&gt;-->
...
<#--&lt;#&ndash;<button class="layui-btn layui-btn-primary layui-btn-sm" type="button" >兜底单</button>&ndash;&gt;-->
<#--</div>-->

<#--</div>-->
    <p style="color: #26bec5;">订单处理 > 我的订单</p>
    <hr style="height: 2px;background-color: #9a9393;" class="layui-bg-blue">
    <form class="layui-form" action="">
        <div class="layui-form-item">
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-block select">
                    <select name="orderType" lay-filter="aihao" id="orderType_s">
                        <option value=""></option>
            ...
            <div class="layui-inline" style="width: 30px;">
                <button class="layui-btn layui-btn-xs layui-btn-disabled" style="display: none" type="button"
                        id="showBtn"> 更多<i class="layui-icon">&#xe65b;</i></button>
            </div>
        </div>
        <div class="layui-form-item" id="secondRow">
            ...
            <div class="layui-inline" style="margin-right:-2px">
                <label class="layui-form-label">出票员：</label>
                <div class="layui-input-inline">
                    <input type="tel" name="grabSingleMember" autocomplete="off" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-inline" style="display: none">
                ...
                <div class="layui-input-block select">
                    <select name="manageStatus" lay-filter="aihao" id="manageStatus">
                        <option value=""></option>
            ...
            <div class="layui-inline">
                <button class="layui-btn layui-btn-primary layui-btn-radius" lay-submit lay-filter="formDemo"
                        style="    padding: 0 0px; width: 44px;height: 27px;line-height: 27px;">查询
                </button>
            </div>
            <div class="layui-inline">
                <button class="layui-btn layui-btn-radius" type="reset"
                        style="    padding: 0 0px;width: 44px;height: 27px;line-height: 27px;">重置
                </button>
            </div>
            <div class="layui-inline" style="width: 30px;display: none">
                <button class="layui-btn layui-btn-xs layui-btn-disabled" type="button" id="hideBtn"><i
                        class="layui-icon">&#xe65a;</i> 隐藏
                </button>
            </div>
        </div>
    <#--<div class="layui-form-item">-->
    ...
    <#--</div>-->
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                <div class="layui-inline" id="statusBtn" style="margin-right: 246px;">
                <#--<button class="layui-btn layui-btn-primary layui-btn-sm" type="button" >全部</button>-->
                    <button class="layui-btn layui-btn-primary layui-btn-sm" type="button">处理中</button>
                    <button class="layui-btn layui-btn-primary layui-btn-sm" type="button">已完成</button>
                <#--<button class="layui-btn layui-btn-primary layui-btn-sm" type="button">已暂存</button>-->
                <#--<button class="layui-btn layui-btn-primary layui-btn-sm" type="button">已超时</button>-->
                <#--<button class="layui-btn layui-btn-primary layui-btn-sm" type="button">已退回</button>-->
                <#--<button class="layui-btn layui-btn-primary layui-btn-sm" type="button">已抽回</button>-->
                </div>
            </div>
            <div class="layui-inline">
                <div class="layui-inline" id="tongjiBtn">

                    <button class="layui-btn layui-btn-primary layui-btn-sm tongjiB" orderType="出票" type="button">
                        出票：<span id="outOrderNum">0</span></button>
                    <button class="layui-btn layui-btn-primary layui-btn-sm tongjiB" orderType="退票" type="button">
                        退票：<span id="exitOrderNum">0</span></button>
                    <button class="layui-btn layui-btn-primary layui-btn-sm tongjiB" orderType="改期" type="button">
                        改期：<span id="editOrderNum">0</span></button>
                    <button class="layui-btn layui-btn-primary layui-btn-sm tongjiB" orderType="航延" type="button">
                        航延：<span id="delayNum">0</span></button>
                    <button class="layui-btn layui-btn-primary layui-btn-sm tongjiB" orderType="" type="button">全部：<span
                            id="totalOrderNum">0</span></button>
                </div>
            </div>
        </div>
    ...
    layui.use(['form', 'element', 'laydate', /*'vip_table',*/'table', 'laytpl'], function () {
        ...
        var options = {
            ...
            , cols: [[                  //标题栏
                ...
                // , {field: 'fromAction', title: '订单来源', width: 86, templet: '#orderTpl'}
                , {field: 'orderProperty', title: '订单属性', width: 86, templet: '#orderTpl'}
                , {field: 'fromAction', title: '订单来源', width: 86}
                , {field: 'expirationTime', title: '倒计时', width: 100, templet: '#timeTpl'}
                , {field: 'orderType', title: '订单类型', width: 86}
                , {field: 'fromSystem', title: '订单渠道', width: 120}
                , {field: 'manageStatus', title: '操作状态', width: 100}
                , {field: 'customers', title: '乘机人', width: 100}
                , {field: 'orderNo', title: '订单号', width: 180}
                , {field: 'externalOrderNo', title: '外部订单号', width: 180}
                , {field: 'orderSort', title: '订单类别', width: 86}
                , {field: 'orderEntranceTime', title: '进单时间', width: 180, templet: '#orderEntranceTimeTpl'}
                , {field: 'confirmTime', title: '完成时间', width: 180, templet: '#outTicketTimeTpl'}//字段是出票时间
                , {field: 'username', title: '处理人', width: 180}
                , {field: 'deptName', title: '处理部门', width: 180}
            ...
            , url: _PATH + "/api/order/selectOrderDto"
            , method: 'post'//'post'
        ...
        table.on('tool(demo)', function (obj) {
            ...
            if (obj.event === 'detail') {
                ...
                var return_url = "/asms/ticket/order/ticketmanager/asmsticketmanagerzcd/list?optflag=ZCD_DCP&sddbh=" + data.orderNo + "&ksrq=2017-01-01&jsrq=" + date + "&force=true";
                if (data.orderType == "改期") {
                    return_url = "/asms/ticket/order/ticketmanager/asmsticketmanagergqd/list?optflag=GQD_DGQ&gqdh=" + data.externalOrderNo + "&ksrq=2017-01-01&jsrq=" + date + "&force=true";
                } else if (data.orderType == "退票") {
                    return_url = "/asms/ticket/order/ticketmanager/asmsticketmanagertfd/list?optflag=TFD_DBL&sddbh=" + data.orderNo + "&ksrq=2017-01-01&jsrq=" + date + "&force=true";
                }
                layer.open({
                    type: 2,
                    title: '差旅查询页',
            ...
            } else if (obj.event === 'return') {//退回
                var params = data;
                $.ajax({
                    url: _PATH + "/api/order/sendBackOrder",
                    data: JSON.stringify(params),
                    contentType: 'application/json',
                    dataType: 'json',	//服务器返回json格式数据2
                    type: 'POST',		//HTTP请求类型
                ...
                //处理中，确认订单
                if (data.orderStatus == "已抢单")
                    confirmGrabbedOrder(data.id);
                else if (data.orderStatus == "已派单") {
                    comfirmDispatchOrder(data.id);
                }
            } else if (obj.event === "tempLock") {
                //暂存
                toggleOrderTempLockStatus(data.id);
            }
        });


        //-----------------------------------------暂存接口----------------------------------------
        function toggleOrderTempLockStatus(id) {

            $.ajax({
                url: _PATH + "/api/order/toggleOrderTempLockStatus",
                data: {orderId: id},
                // contentType: 'application/json',
                dataType: 'json',	//服务器返回json格式数据2
                type: 'POST',		//HTTP请求类型
...
//-------------------------已抢订单确认接口-----------------------------------
        ...
        function confirmGrabbedOrder(orderId) {
        ...
        //-------------------------已派单确认接口-----------------------------------
        function comfirmDispatchOrder(orderId) {
...
//         $("#statusBtn button").eq(0).css("color","red");
        $("#statusBtn button").click(function (e) {
            ...
            if (flag == "全部") options.where.manageStatus = null;
            table.reload('dataCheck', options);
            if (flag == "处理中") {
        ...
        $("#switchBtn").click(function (e) {
            ...
            if (flag == "待抢单") {
                ...
                window.parent.addTab_parent(_PATH + "/trade/pending-order-dot.html", "待抢单", layer);
            ...
            $.ajax({
                ...
                success: function (_data) {
                    if (_data.success) {
                        ...
                        $.ajax({
                            url: _PATH + "/api/order/countOrderTypeNum",
                            data: JSON.stringify({orderStatus: "已派单"}),
                            // contentType: false,//form表单提交这里
                            // processData: false,//form表单提交这两个一定设置为false
                            contentType: 'application/json',
                            dataType: 'json',	//服务器返回json格式数据2
                            ...
                            success: function (__data) {
                                if (__data.success) {
                                    $("#totalOrderNum").html(_data.obj.totalOrderNum + __data.obj.totalOrderNum);
                                    $("#outOrderNum").html(_data.obj.outOrderNum + __data.obj.outOrderNum);
                                    $("#exitOrderNum").html(_data.obj.exitOrderNum + __data.obj.exitOrderNum);
                                    $("#editOrderNum").html(_data.obj.editOrderNum + __data.obj.editOrderNum);
                                    $("#delayNum").html(_data.obj.delayNum + __data.obj.delayNum);
                                } else {
        ...
        function showTabNav() {
            console.log("--切换--", window.parent.getThisNavTab("/trade/already-robbed-master.html"));
        }


        //开始抢单倒计时

        var robbingOrderTime;
        robbingOrderTimeHandler();

        function robbingOrderTimeHandler() {

            if (robbingOrderTime)
                clearInterval(robbingOrderTime);
            robbingOrderTime = setInterval(function () {

                $('.robOutTime').each(function (index, item) {

                    var robOutTime = $(item).attr("data-time");


                    var de = new Date();
                    var a = robOutTime - de.getTime();
                    var msg = "00:00";
                    if (a < 0) a = 0;
                    else {
                        a = a / 1000 / 60;
...
<script type="text/html" id="grabSingleTimeTplTpl">

    {{#
    var fn = function(){

    return d.grabSingleTime?(new Date(d.grabSingleTime)).Format('yyyy-MM-dd HH:mm:ss'):"";
    };
    }}
    {{ fn() }}
</script>
...
<script type="text/html" id="lockSingleTimeTpl">

    {{#
    var fn = function(){

    return d.lockSingleTime?(new Date(d.lockSingleTime)).Format('yyyy-MM-dd HH:mm:ss'):"";
    };
    }}
    {{ fn() }}
</script>
<script type="text/html" id="outTicketTimeTpl">

    {{#
    var fn = function(){

    return d.outTicketTime?(new Date(d.outTicketTime)).Format('yyyy-MM-dd HH:mm:ss'):"";
    };
    }}
    {{ fn() }}
</script>
...
<script type="text/html" id="grabSingleTimeTpl">
...
<script type="text/html" id="timeTpl">
    ...
    var a = d.expirationTime-de.getTime();
    console.log(d.expirationTime);
    ...
    return   '<span class="robOutTime" data-time="'+d.expirationTime+'">'+msg+'</span>';
    };
    }}
    {{ fn() }}
</script>
<#--表格里面的时间格式化-->
<script type="text/html" id="dealOutTimeTpl">

    {{#
    var fn = function(){
    var de = new Date();
    var a = d.dealOutTime-de.getTime();
    var msg="00:00";
    if(a <0)a=0;
    else{
    a = a/1000/60;
...
<script type="text/html" id="barOption">
    ...
    <#--<a class="layui-btn layui-btn-primary layui-btn-xs" lay-event="unlock">解</a>-->
    {{# if(d.manageStatus  == "待处理"){ }}
    <a class="layui-btn layui-btn-primary layui-btn-xs" lay-event="sure">确</a>
    {{#  } }}
    {{# if(d.manageStatus  == "已确认" ){ }}
    <a class="layui-btn layui-btn-primary layui-btn-xs" lay-event="tempLock">存</a>
    {{#  } }}
    {{# if(d.manageStatus  == "已暂存" ){ }}
    <a class="layui-btn layui-btn-primary layui-btn-xs" lay-event="tempLock">释</a>
    {{#  } }}

    {{# if(d.manageStatus  != "已退回"&&d.manageStatus  != "已完成"&&d.manageStatus  != "已暂存"){ }}
    <a class="layui-btn layui-btn-primary layui-btn-xs" lay-event="return">退</a>
    {{#  } }}
    <a class="layui-btn layui-btn-xs" lay-event="endorsement">签</a>
    <a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="journal">日</a>
</script>
