package com.yihexinda.dataservice.config;
...
//@Configuration
//指定扫描的mapper接口所在的包
@MapperScan(basePackages = "com.yihexinda.dataservice.dao", sqlSessionFactoryRef = "DBDataSqlSessionFactory")
public class DataSourceConfig {
    ...
    public SqlSessionFactory sqlSessionFactory(@Qualifier("DBDataSource") DataSource dataSource)
        ...
        bean.setTypeHandlersPackage("com.yihexinda.shenhang.scheduling.dataservice.handler.typehandler");
