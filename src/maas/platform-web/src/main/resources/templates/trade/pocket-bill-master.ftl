...
<script type="text/javascript">
    layui.use(['form','element','laydate',/*'vip_table',*/'table' ,'laytpl'], function () {
        ...
        var options = {
          ...
          //  , height: 500    //容器高度
            , cols: [[                  //标题栏
                ...
                , {field: 'orderProperty', title: '订单属性', width: 110,templet: '#orderTpl'}
                ...
                , {field: 'dealOutTime', title: '处理时间', width: 120,templet:"#dealOutTimeTpl"}
        ...
        $("#switchBtn button").eq(4).css("color","red");
        $("#switchBtn").click(function(e){
            ...
            if(flag=="待抢单"){
                //调用父页面index.js添加菜单方法
                var layId =  window.parent.getThisTabID();//getTitleId_children('card',"兜底单");
...
//---切换----
        showTabNav();
        function showTabNav(){
            console.log("--切换--",window.parent.getThisNavTab("/trade/pocket-bill-master.html")) ;
        }
...
<script  type="text/html" id="orderTpl">
    ...
    {{#  } else { }}
            {{# if(d.orderProperty.length<3){ }}
                 <span class="layui-badge" style="width: 44px;">{{d.orderProperty}}</span>
            {{#  } else { }}
                     <span class="layui-badge" style="width: 73px;">{{d.orderProperty}}</span>
            {{#  } }}
    {{#  } }}
...
<script  type="text/html" id="dealOutTimeTpl">
    ...
    return d.dealOutTime?(new Date(d.dealOutTime)).Format('yyyy-MM-dd HH:mm:ss'):"";
    };
    }}
    {{ fn() }}
</script>
...
<script type="text/html" id="barOption">
    ...
    <#--<a class="layui-btn layui-btn-primary layui-btn-xs" lay-event="lock">锁单</a>-->
