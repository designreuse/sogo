        ...
        <#--<div class="layui-colla-content">-->
            ...
            <#--</div>-->
                <div class="layui-form-item">
                    ...
                    <div class="layui-inline">
                        <label class="layui-form-label" style="width: 700px;">总订单：<span style="color: red;">0</span>单，出票：<span
                                style="color: red;">0</span>单，退票：<span style="color: red;">0</span>单，改期：<span
                                style="color: red;">0</span>单，航延：<span style="color: red;">0</span>单</label>
                    </div>
                </div>
            </form>
        <#--</div></div></div>-->
    ...
    layui.use(['form', 'element', 'laydate', /*'vip_table',*/'table', 'laytpl'], function () {
        ...
        table.on('tool(demo)', function (obj) {
            ...
            if (obj.event === 'detail') {
                ...
                $.ajax({
                    url: _PATH + "/api/order/confirmGrabbedOrder/" + data.id,
