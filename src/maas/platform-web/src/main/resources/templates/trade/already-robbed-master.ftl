                ...
                <form class="layui-form" action="">
                    ...
                    <div class="layui-form-item" id="secondRow">
                        ...
                        <div class="layui-inline"  style="margin-right:-2px">
                            <label class="layui-form-label" id="grabSingleMember_lab">出票员：</label>
                            <div class="layui-input-inline">
                                <input type="tel" name="grabSingleMember"  autocomplete="off" placeholder="姓名/工号" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-inline">
...
<script type="text/javascript">
    layui.use(['form','element','laydate',/*'vip_table',*/'table' ,'laytpl'], function () {
        ...
        var options = {
          ...
          //  , height: 500    //容器高度
            , cols: [[                  //标题栏
                ...
                , {field: 'externalOrderNo', title: '外部订单号', width: 130}
                ...
                , {field: 'grabSingleTime', title: '抢单时间', width: 180,templet: '#grabSingleTimeTpl'}
                , {field: 'dealOutTime', title: '处理倒计时', width: 100,templet: '#dealOutTimeTpl'}
                , {field: 'dealOutTime', title: '处理时长', width: 100,templet: '#dealOutTimeTpl'}
                , {field: 'manageStatus', title: '处理状态', width: 100}
                , {field: 'lockSingleTime', title: '确认时间', width: 180 ,templet:'#lockSingleTimeTpl'}
                , {field: 'grabSingleMember', title: '抢单单员', width: 120}
                , {field: 'deptId', title: '抢单部门', width: 120}
                , {field: 'outTicketTime', title: '出票时间', width: 180 ,templet:'#outTicketTimeTpl'}
                , {field: 'outTicketMember', title: '处理员', width: 180}
        ...
        ///-------------------------------------状态切换按钮----------------------------------------------
        $("#statusBtn button").eq(1).css("color","red");
...
<script type="text/html" id="barOption">
    ...
    <a class="layui-btn layui-btn-primary layui-btn-xs" lay-event="return">抽</a>
