    ...
    layui.use(['form','element','laydate',/*'vip_table',*/'table' ,'laytpl'], function () {
        ...
        var options = {
          ...
          //  , height: 500    //容器高度
            , cols: [[                  //标题栏
                ...
                , {field: 'orderEntranceTime', title: '进单时间', width: 180 ,templet:'#orderEntranceTpl' }
                , {field: 'grabSingleTime', title: '处理倒计时', width: 120,templet:'#grabSingleTimeTpl'}
                , {field: 'grabSingleMember', title: '接单员', width: 120}
                , {field: 'deptId', title: '接单部门', width: 120}
        ...
        form.on('submit(formDemo)', function(data){
           // layer.msg(JSON.stringify(data.field));
            ...
            return false; table.reload('dataCheck',options);
        });
...
<script  type="text/html" id="grabSingleTimeTpl">
    ...
    var fn = function(){
    var de = new Date();
    var a = d.grabSingleTime-de.getTime();
    var msg="00:00";
    if(a <0)a=0;
    else{
    a = a/1000/60;
