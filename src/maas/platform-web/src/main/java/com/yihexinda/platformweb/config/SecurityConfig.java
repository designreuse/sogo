...
import com.yihexinda.platformweb.security.CustomPasswordEncoder;
...
public class SecurityConfig {
    ...
    public static class PlatformWebSecurityConfigurerAdapter extends WebSecurityConfigurerAdapter {
        ...
        public void configure(WebSecurity web) throws Exception {
            web.ignoring().antMatchers("/assets/**", "/v2/api-docs", "/configuration/ui", "/swagger-resources/**", "/configuration/security", "/swagger-ui.html", "/webjars/**");
        }

        @Override
        protected void configure(HttpSecurity http) throws Exception {
            http
                    .csrf().disable().addFilterBefore(new StaticResourceFilter(), BasicAuthenticationFilter.class)
                    .antMatcher("/**")
                    .authorizeRequests()
                    ...
                    .anyRequest().hasAnyAuthority(AuthoritiesConstants.PLATFORM_MANAGEMENT)
                    .and()
                    .formLogin()
