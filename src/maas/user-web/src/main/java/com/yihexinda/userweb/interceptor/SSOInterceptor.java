package com.yihexinda.userweb.interceptor;
...
//                        resultVo.setResult(ResultConstant.SYS_REQUIRED_UNLOGIN_ERROR);
//                        resultVo.setMessage(ResultConstant.SYS_REQUIRED_UNLOGIN_ERROR_VALUE);
                        response.getWriter().write(JsonUtil.toJson(resultVo));
                        return false;
                    }
